...
describe('Test cases for Cart flow', () => {
    ...
    context('Checkout flow', () => {
           ...
           cy.get('#tablerate').check();
            ...
            cy.get('select[name="custom_attributes[province_id]"]').then($select => {
              ...
              cy.get('input[name="street[0]"]').type(streetName);
                ...
                cy.get('input[name="custom_attributes[number]"]').type(randomNumber);
        ...
        //Verificar que usuario Guest puede avanzar al pago seleccionando "Retiro en sucursal Chilexpress" - Guest
        it('CO-003: Verify that Guest user can proceed to checkout by selecting "Pick up at Chilexpress branch" - Guest', () => {
            ...
            //Seleccionar tipo de despacho "Retiro en sucursal Chilexpress" 
            cy.get('#deliveryexpress').check();
        ...
        it('CO-004: Verify that existing account validation is performed for a Guest user in Checkout - GUEST', () => {
            ...
            cy.get('#tablerate').check();
             ...
             cy.fixture('usuariosRegistrados').then(usuario => {
                cy.get('input[name="custom_attributes[identification_number]"]').type(usuario[0].rut)
            });
        ...
        it('CO-007: Verify that Logged in user can proceed to checkout by selecting "Pick up in store (Free Shipping)" - Login', () => {
         ...
         //Verificar que usuario logueado puede avanzar al pago seleccionando "Retiro en sucursal Chilexpress" - Login
         it('CO-008: Verify that Logged in user can proceed to checkout by selecting "Pick up at Chilexpress branch" - Login', () => {
